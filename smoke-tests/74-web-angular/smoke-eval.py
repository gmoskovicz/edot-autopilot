#!/usr/bin/env python3
"""Eval test: Web — Angular 17 ShopClient. Run: cd smoke-tests && python3 74-web-angular/smoke-eval.py"""
...
SVC="74-web-angular"; FIXTURE_DIR=os.path.join(os.path.dirname(__file__),"fixtures","blank-angular-shop")
...
print(f"\n{'='*62}\nEDOT-Autopilot | {SVC}\n{'='*62}")
print("  Fixture: blank-angular-shop (Angular 17, no OTel)  |  NOTE: Live run SKIPPED\n")
...
tmpdir=tempfile.mkdtemp(prefix="edot-autopilot-angular-")
try:
    ...
    subprocess.run(["git","commit","-m","initial: blank Angular app, no observability"],cwd=tmpdir,capture_output=True,check=True)
